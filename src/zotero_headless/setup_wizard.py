...
def _apply_base_settings(existing: Settings) -> Settings:
    return Settings(
        ...
        recovery_snapshot_dir=str(existing.resolved_recovery_snapshot_dir()),
        recovery_temp_dir=str(existing.resolved_recovery_temp_dir()),
        recovery_auto_snapshots=existing.recovery_auto_snapshots,
        backup_repositories=list(existing.backup_repositories),
